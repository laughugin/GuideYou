...
class App extends Component {
  ...
  handleLogout = () => {
    this.setState({ credentialResponse: null, userName: '', userProfilePic: '' }); 
  ...
  render() {
    const { coordinates, directions, hotels, uploadedFile, loading, userLocation, sortOption, locationResponse, filterVisible, dataFetched, directionsVisible, guessedCoordinates, credentialResponse, userName, userProfilePic } = this.state;
        ...
        <header style={{
          ...
          {credentialResponse ? (
            <div style={{ color: 'white', display: 'flex', alignItems: 'center' }}>
              {userProfilePic && <img src={userProfilePic} alt="Profile" style={{ width: '40px', height: '40px', borderRadius: '50%', marginRight: '8px' }} />}
              Welcome, {userName}!
              <Button
